...
namespace ReturnPoint
{
    public class FormGalleryHeadAdmin : Form
    {
        ...
        public FormGalleryHeadAdmin()
        {
            ...
            // --- ACCOUNT MANAGEMENT SECTION (HeadAdmin Only) ---
            controlFlow.Controls.Add(CreateSectionTitle("👥 User Management"));
            ...
            btnCreateAccount.Click += (s, e) => OpenCreateAccountForm();
            btnInbox.Click += (s, e) =>
            {
        ...
        private void LoadImagesSync(bool showDeleted, string searchQuery)
        {
            ...
            if (newColumns != currentColumnCount)
            {
                currentColumnCount = newColumns;
                galleryTable.ColumnCount = currentColumnCount;
